...
## What to do
1. Render the menu below using the SAME formatting (markdown headings + the **What it does / Sources / You control**
   preview lines AND the **How to run** block — the slash command plus 2-3 sample natural-language prompts — per skill).
...
**How to run:**
- Command: `/pmc-fortnightly-dashboard` (latest sprint) · `/pmc-fortnightly-dashboard Sprint 12` (a specific sprint; `S12` works too)
...
- *Output:* the brief in chat. *You control:* archiving to Drive + the Executive Briefs Log, and the Gmail email — placed as a **DRAFT** for you to review & send (never sent for you).

**How to run:**
- Command: `/pmc-executive-brief` (latest sprint) · `/pmc-executive-brief Sprint 12` (a specific sprint; `S12` works too)
...
- *Output:* the full governance picture **in chat first** — reds-first, with overdue/unowned flags. *You control:* I ask before publishing — only on your OK does it go to a dated Confluence page + a #atlas heads-up.

**How to run:**
- Command: `/pmc-governance-intelligence`
